            ...
            if(!empty($rphone)){
                if(!empty($rp1name)){
                    if(!empty($rp2name)){
                            ...
                            if(!empty($rp2g)){
                                if(!empty($rp1dob)){
                                    if(!empty($rp2dob)){
                                            ...
                                            if(!empty($rp2pin)){
                                                if(!empty($rp1add)){
                                                    if(!empty($rp2add)){
                                                        ...
                                                        echo "Parent 2 address cant be empty!";
                                                        die();
                                                    }
                                                }
                                                else{
                                                ...
                                                echo "Parent 2 Pincode cant be empty!";
                                                die();
                                            }
                                        }
                                        else{
                                        ...
                                        echo "Parent 2 DOB cant be empty!";
                                        die();
                                    }
                                }
                                else{
                                ...
                                echo "Parent 2 Gender cant be empty!";
                                die();
                            }
                        }
                        else{
                        ...
                        echo "Parent 2 Name cant be empty!";
                        die();
                    }
                }
                else{
                ...
                echo "Registerer Phone no cant be empty!";
                die();
            }
        }
        else{
            echo "Registerer Email cant be empty!";
            die();
        }
    }
    else{
        echo "Registerer Last Name cant be empty!";
        die();
    }
}
else{
    echo "Registerer First Name cant be empty!";
    die();
}
?>